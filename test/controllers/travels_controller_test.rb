...
class TravelsControllerTest < ActionController::TestCase
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post :create, travel: { created_at: @travel.created_at, friend: @travel.friend, title: @travel.title, travel: @travel.travel }
    end
  ...
  test "should update travel" do
    patch :update, id: @travel, travel: { created_at: @travel.created_at, friend: @travel.friend, title: @travel.title, travel: @travel.travel }
    assert_redirected_to travel_path(assigns(:travel))
  end
